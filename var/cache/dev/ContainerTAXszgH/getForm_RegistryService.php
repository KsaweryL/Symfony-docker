...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\Type\\LoginPageType' => ['privates', 'App\\Form\\Type\\LoginPageType', 'getLoginPageTypeService', true],
            'App\\Form\\Type\\TaskType' => ['privates', 'App\\Form\\Type\\TaskType', 'getTaskTypeService', true],
            'App\\Form\\Type\\UserDataSQLType' => ['privates', 'App\\Form\\Type\\UserDataSQLType', 'getUserDataSQLTypeService', true],
            'App\\Form\\Type\\UserDataSQLUpdateType' => ['privates', 'App\\Form\\Type\\UserDataSQLUpdateType', 'getUserDataSQLUpdateTypeService', true],
            'App\\Form\\Type\\UserDataType' => ['privates', 'App\\Form\\Type\\UserDataType', 'getUserDataTypeService', true],
            'App\\Form\\Type\\WelcomePageType' => ['privates', 'App\\Form\\Type\\WelcomePageType', 'getWelcomePageTypeService', true],
            ...
            'App\\Form\\Type\\LoginPageType' => '?',
            'App\\Form\\Type\\TaskType' => '?',
            'App\\Form\\Type\\UserDataSQLType' => '?',
            'App\\Form\\Type\\UserDataSQLUpdateType' => '?',
            'App\\Form\\Type\\UserDataType' => '?',
            'App\\Form\\Type\\WelcomePageType' => '?',

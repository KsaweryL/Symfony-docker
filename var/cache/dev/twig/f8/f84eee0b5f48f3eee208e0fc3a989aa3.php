...
class __TwigTemplate_b35e3d2c7b88797683ccd766efa84acd extends Template
{
    private $source;
    private $macros = [];
...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "/home/zipek/Docker_projects/symfony-docker-5/dockerized_sf_project/vendor/symfony/web-profiler-bundle/Resources/views/Collector/messenger.html.twig");
    }
}
